...
public final class animationUVSwap extends Table {
  ...
  public Vector2 ReadScale()
  {
	  return new Vector2(scale(0), scale(1));
  }
  
  public Vector2 ReadLocalOffset()
  {
	  return new Vector2(localOffset(0), localOffset(1));
  }

  public Vector2 ReadGlobalOffset()
  {
	  return new Vector2(globalOffset(0), globalOffset(1));
  }
